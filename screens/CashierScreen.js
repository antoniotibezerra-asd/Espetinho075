...
const styles = StyleSheet.create({
  ...
  metricLabel:  { fontSize: 12, color: '#000', marginBottom: 8, fontWeight: '900' },
  metricVal:    { fontSize: 20, fontWeight: '900', color: '#000' },
  card:         {
    backgroundColor: '#fff',
    borderRadius: 12,
    borderWidth: 1,
  ...
  histRow:      { flexDirection: 'row', alignItems: 'center', gap: 12, paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: '#111' },
  histCircle:   { width: 32, height: 32, borderRadius: 16, backgroundColor: '#fff', borderWidth: 1, borderColor: '#111', alignItems: 'center', justifyContent: 'center' },
  histCircleText:{ fontSize: 10, fontWeight: '900', color: '#000' },
  histMesa:     { fontSize: 13, fontWeight: '900', color: '#000' },
  histSub:      { fontSize: 12, color: '#000', fontWeight: '800' },
  histTotal:    { fontSize: 14, fontWeight: '900', color: '#000' },
  progBar:      { height: 6, backgroundColor: '#fff', borderRadius: 3, overflow: 'hidden', borderWidth: 1, borderColor: '#111' },
  progFill:     { height: '100%', backgroundColor: '#000', borderRadius: 3 },
  ...
  fechadoTitle: { fontSize: 13, fontWeight: '900', color: '#000' },
  fechadoSub: { fontSize: 12, color: '#000', marginTop: 2, fontWeight: '800' },
  ...
  btnPrimary: { backgroundColor: '#fff', borderWidth: 1, borderColor: '#111', borderRadius: 8, paddingVertical: 12, alignItems: 'center', marginTop: 12 },
